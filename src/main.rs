...
<p class="note" style="font-size:1.2rem">オーディオ入門用として、100円ショップでも、SONY WALKMANやDAP（デジタルオーディオプレーヤー）、スマートフォン・タブレット・PCと接続する前提で、消費税込み110円から、高くても数千円くらいで、Bluetooth接続のものや、USB Type-C＆3.5mmステレオコネクター接続のもの、3.5mmイヤホン・ヘッドホン、クリップ式（耳掛け式）のものなどを販売しているお店もございます。<br><br>As an introduction to audio, there are also stores, such as 100-yen shops, that sell items intended for connecting to Sony Walkman players, DAPs (digital audio players), smartphones, tablets, and PCs, priced from 110 yen including consumption tax up to a few thousand yen at most: Bluetooth models, USB Type-C and 3.5mm stereo connector models, 3.5mm earphones and headphones, and clip-on (ear-hook) types.</p>
