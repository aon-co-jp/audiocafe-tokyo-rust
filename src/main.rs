...
<p class="note" style="font-size:1.2rem">熱心なAUDIOファンで音質の良いDDC＋USB-DAC次期製品を希望している者と致しまして、<br>As an avid AUDIO fan, my request for a good-sounding next-generation DDC + USB-DAC product is as follows:</p>
