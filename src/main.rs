...
<p class="note">熱心なAUDIOファンで音質の良いDDC＋USB-DAC次期製品の希望としましては、<br>As an avid AUDIO fan, my request for a good-sounding next-generation DDC + USB-DAC product is as follows:</p>
<p class="note">日本語:<br>Musician Audio「USB DAC PEGASUS」シリーズの次期製品として、ローム（ROHM）製フラッグシップD/AコンバーターIC「BD34302EKV」を4基（クアッド構成）搭載したモデルの発売を希望します。<br><br>English:<br>As a request for the next product in Musician Audio's "USB DAC PEGASUS" series, I would like to see a model equipped with four (quad configuration) ROHM "BD34302EKV" flagship D/A converter ICs.</p>
