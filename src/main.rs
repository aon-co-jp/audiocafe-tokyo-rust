...
<p class="note" style="font-size:1.2rem">最近は、ブルートゥースよりもWifiの方が、更に4.4mmバランスの有線の方が音質が良いとされております。<br><br>These days, Wi-Fi is said to offer better sound quality than Bluetooth, and a wired 4.4mm balanced connection is said to sound even better still.</p>
